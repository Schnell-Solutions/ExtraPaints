...
SECRET_KEY = 'django-insecure-q+$u+mb^2a#cfk1uf05j7dz&ucx=jevqdyn!ji(+m4ka$%p+&b'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

CSRF_TRUSTED_ORIGINS = ['https://e8a43b08b63a.ngrok-free.app']

ALLOWED_HOSTS = ['e8a43b08b63a.ngrok-free.app', 'localhost', '127.0.0.1']
